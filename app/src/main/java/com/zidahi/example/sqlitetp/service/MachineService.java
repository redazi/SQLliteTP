package com.zidahi.example.sqlitetp.service;
...
import com.zidahi.example.sqlitetp.dao.IDao;
import com.zidahi.example.sqlitetp.util.MySQLiteHelper;
    ...
    public List<Machine> findAll() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                machine.setRefernce(cursor.getString(2));
                System.out.println(machine.getRefernce());
                machine.setSalle(salleService.findById(cursor.getInt(3)));
                // Add salle to salle
